...
var STRING_INSERTED, STRING_INVERSIONFIRST, STRING_INVERSIONSECOND, STRING_MATCH, STRING_MISSED, STRING_SPACE, STRING_SUBSTITUTION, addKeyEvent, addNotes, alphabet, blast_text, corpus_lines, d_rows, displayKeyboard, getMusicFileForNote, getNoteAlpha, getSubstitutionScore, getUrlParameters, highlightButton, highlightButtonTarget, initLineLog, m_rows, makeButton, make_key_mapping, matchLength, maxLineReached, nextLine, playNote, postToServer, q_rows, removeNonAlpha, removeWhitespace, root, sendLineLog, sendStartLog, setCaretToPos, setSelectionRange, sharpToFlat, showLine, substitution_table, to_dvorak, to_piano, transformTypedChar, unhighlightButton, updateProgress, updateText;
...
updateProgress = function(lineNum) {
  ...
  return $('#progressIndicator').text('Progress: ' + lineNum + ' / ' + totalLines);
};
...
updateText = function(forced) {
  var chunk, nextNote, ntext, numMatched, numNotesEntered, reftext_entered, reftext_todo, _i, _len, _ref;
  if (forced == null) {
    forced = false;
  }
  ntext = $('#textInput').val();
