...
var acceptHIT, checkCode, checkIfHITDoneCookies, codeKeypress, documentReady, getUrlParameters, getWorkerId, insertScript, isChrome, isComboBoxZero, isRadioEmpty, isTextEmpty, nextYearDateString, pleaseAnswer, previewHIT, root, taskAcceptedByWorker, testPlayNote, toHitCode, validateForm;
...
documentReady = function() {
  ...
  if (!isChrome()) {
    ...
    return $('#hitcode').attr('disabled', 'disabled');
  } else {
