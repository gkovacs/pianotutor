...
(function() {
  ...
  taskAcceptedByWorker = function(accepted_taskname) {
    var submitButton;
  ...
  acceptHIT = root.acceptHIT = function() {
    var previously_accepted_taskname;
    ...
    if (previously_accepted_taskname === taskname || previously_accepted_taskname === '') {
      return console.log('previously accepted hit');
    } else {
      return console.log('previously accepted other hit');
    }
  };
  ...
  documentReady = function() {
    ...
    if (!isChrome()) {
      ...
      if (workerid !== '') {
        return startTask.href = '//pianotutor.herokuapp.com/mturk_index_' + root.taskname + '.html?workerId=' + encodeURI(workerid);
      }
    }
  };
