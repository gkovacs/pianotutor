...
(function() {
  var acceptHIT, checkCode, codeKeypress, documentReady, getCookieValue, getUrlParameters, getWorkerId, insertScript, isChrome, isComboBoxZero, isRadioEmpty, isTextEmpty, pleaseAnswer, previewHIT, root, taskAcceptedByWorker, testPlayNote, toHitCode, validateForm;
  ...
  taskAcceptedByWorker = root.taskAcceptedByWorker = function(accepted_taskname) {
    var existing_keys, tasknameCookieVal;
    if (accepted_taskname === '' || accepted_taskname === root.taskname) {
      ...
      if ((tasknameCookieVal == null) || tasknameCookieVal === '') {
